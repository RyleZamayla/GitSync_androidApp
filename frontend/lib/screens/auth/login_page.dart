            ...
            child: ListView(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Row(
                    children: const [
                      ///credit to Icon8 for the twitter icon
                      SizedBox(width: 50,),
                      Image(
                      ...
                      SizedBox(width: 5,),
                      Text("Continue with Google", style: TextStyle(color: CupertinoColors.black, fontWeight: FontWeight.bold),)
                    ],
                  ),
                ),
                Padding(
