      ...
      body: Form(
        ...
        child: ListView(
          children: [
            ...
            Lottie.asset('assets/splash/mobile_dev.json', width: 200, height: 120),
            const Text(
              'Git-Sync',
              textAlign: TextAlign.center,
              style:
                  TextStyle(fontFamily: 'Ubunto', color: Color(0xFFBCAAA4), fontSize: 25, fontWeight: FontWeight.bold),
            ),
            const Expanded(
              child: Text(
                'Click  Post  React  ',
                textAlign: TextAlign.center,
                style: TextStyle(
                    fontFamily: 'Ubunto', color: Color(0xFFD7CCC8), fontSize: 18, fontWeight: FontWeight.bold),
              ),
            ),
            const SizedBox(
              height: 50,
            ...
            ListTile(
              ...
              title: const Text(
                'Profile',
                style: TextStyle(
                    color: Color(0xFFE0E0E0), fontFamily: 'Ubunto', fontSize: 16, fontWeight: FontWeight.bold),
              ),
              onTap: () {
