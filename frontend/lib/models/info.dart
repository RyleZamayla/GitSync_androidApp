import 'dev_info.dart';
  ...
  final devInfo = <User>[
    ...
    User(name: "Angel Rose Naval", bio: "\n", location: "\nlocation", urlImage: "assets/profile_pic/naval.png"),
    ...
    User(name: "Carl Amiel Tristan Moron", bio: "\n", location: "\nlocation", urlImage: "assets/profile_pic/moron.png"),
